...
export function createAdminDateRangeQuery(days: number, now: Date = new Date()): AdminAnalyticsDateRangeQuery {
...
export function createAdminListQuery(days: number, limit = 20, now: Date = new Date()): AdminAnalyticsListQuery {
