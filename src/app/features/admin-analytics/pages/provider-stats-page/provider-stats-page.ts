...
@Component({ selector: 'wx-provider-stats-page', imports: [ErrorState, Spinner], templateUrl: './provider-stats-page.html', changeDetection: ChangeDetectionStrategy.OnPush })
export class ProviderStatsPage implements OnInit {
  ...
  protected load(): void { this.facade.loadProviderStats(createAdminDateRangeQuery(this.dateRangeDays())); }
