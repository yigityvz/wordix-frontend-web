...
import { ConfidenceScoreBucketResponseDto, ConfidenceScoreDistributionResponseDto, DeckStatisticsItemResponseDto, DeckStatisticsResponseDto, DifficultLearningItemResponseDto, QuizStatisticsResponseDto, UserLearningSummaryResponseDto } from './statistics-api.models';
...
export interface DifficultLearningItemsPage extends Omit<PagedResult<DifficultLearningItem>, 'items'> { readonly items: readonly DifficultLearningItem[]; }
...
export interface DeckStatistics extends Omit<DeckStatisticsResponseDto, 'items'> { readonly items: readonly DeckStatisticsItem[]; }
...
export interface ConfidenceScoreDistribution extends Omit<ConfidenceScoreDistributionResponseDto, 'buckets'> { readonly buckets: readonly ConfidenceScoreBucket[]; }
