...
export const QUIZ_ROUTES: Routes = [
  {
    ...
    children: [
      { path: 'start', loadComponent: () => import('./pages/quiz-start-page/quiz-start-page').then((module) => module.QuizStartPage) },
      { path: ':quizSessionId/play', loadComponent: () => import('./pages/quiz-play-page/quiz-play-page').then((module) => module.QuizPlayPage) },
      { path: ':quizSessionId/summary', loadComponent: () => import('./pages/quiz-summary-page/quiz-summary-page').then((module) => module.QuizSummaryPage) },
