  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: QuizFacade, useValue: { isSummaryLoading: signal(false), summaryError: signal(null), summary, loadSummary, clearSummary } },
      ],
    });
...
function createSummary(): QuizSummary {
  return { quizSessionId: 'session-1', quizType: 'Test', quizSourceType: 'UserDictionary', quizContentMode: 'Mixed', status: 'InProgress', startedAt: '2026-01-01T00:00:00Z', totalQuestionCount: 4, answeredQuestionCount: 3, unansweredQuestionCount: 1, correctAnswerCount: 2, wrongAnswerCount: 1, accuracyRate: 75, completionRate: 75, averageQuestionResponseTimeInMilliseconds: 1500, fastestQuestionResponseTimeInMilliseconds: 1000, slowestQuestionResponseTimeInMilliseconds: 2000, questions: [{ quizQuestionId: 'question-1', questionOrder: 1, questionText: 'Choose hello', learningItemId: 'item-1', isAnswered: true, isCorrect: false, selectedQuizOptionId: 'option-1', selectedAnswerText: 'Selam', correctAnswerText: 'Merhaba', questionResponseTimeInMilliseconds: 1500, answeredAt: '2026-01-01T00:00:01Z' }] };
}
